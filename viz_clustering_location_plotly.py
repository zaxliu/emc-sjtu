...
profile_path = net_traffic_path+".profile/CommunicationTotalByte_location.pkl"        # Profile used for clustering
...
viz_profile_path2 = net_traffic_path+".profile/CommunicationTotalByte_location.pkl"   # Visualization matrix #2
...
plt.ylim([0, 1])
plt.legend(["Undergraduate", 'Master', 'PhD'])
...
plot_url = py.plot(data, filename='location-gender')
